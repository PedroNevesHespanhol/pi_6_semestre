...
var findUserBySlug = (slug) => __async(void 0, null, function* () {
...
var getUserFollowingCount = (slug) => __async(void 0, null, function* () {
  const count = yield prisma.follow.count({
    where: { user1Slug: slug }
  });
  return count;
});
var getUserFollowersCount = (slug) => __async(void 0, null, function* () {
  const count = yield prisma.follow.count({
    where: { user2Slug: slug }
  });
  return count;
});
var getUserPostsCount = (slug) => __async(void 0, null, function* () {
  const count = yield prisma.post.count({
    where: { userSlug: slug }
  });
  return count;
});
var findPostsByUser = (slug, currentPage, perPage) => __async(void 0, null, function* () {
...
var updateUserInfo = (slug, data) => __async(void 0, null, function* () {
...
var updateUserSchema = import_zod2.z.object({
  name: import_zod2.z.string({ message: "Nome obrigat\xF3rio" }).min(3, { message: "M;\xEDnimo 2 caracteres" }).optional(),
